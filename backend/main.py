...
from backend.routers import research, planner, explainability, security, auth, fairness
...
app.include_router(fairness.router,       prefix="/fairness",       tags=["Fairness Check"])
